...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        Reset_MainWebview_Button = New Button()
        ...
        Line_Number_NumericUpDown.Maximum = New Decimal(New Integer() {1215752191, 23, 0, 0})
        ...
        Message_RichTextBox.Size = New Size(364, 289)
        ...
        MainWebView2.Location = New Point(644, 29)
        MainWebView2.Name = "MainWebView2"
        MainWebView2.Size = New Size(660, 590)
        MainWebView2.Source = New Uri("https://www.baidu.com/", UriKind.Absolute)
        MainWebView2.TabIndex = 37
        MainWebView2.ZoomFactor = 1R
        ' 
        ' Label15
        ' 
        Label15.AutoSize = True
        Label15.Location = New Point(382, 308)
        ...
        Debug_Msg_ListBox.Location = New Point(382, 330)
        Debug_Msg_ListBox.Name = "Debug_Msg_ListBox"
        Debug_Msg_ListBox.Size = New Size(256, 289)
        Debug_Msg_ListBox.TabIndex = 39
        ' 
        ' Reset_MainWebview_Button
        ' 
        Reset_MainWebview_Button.Location = New Point(544, 264)
        Reset_MainWebview_Button.Name = "Reset_MainWebview_Button"
        Reset_MainWebview_Button.Size = New Size(94, 29)
        Reset_MainWebview_Button.TabIndex = 40
        Reset_MainWebview_Button.Text = "Reset"
        Reset_MainWebview_Button.UseVisualStyleBackColor = True
        ' 
        ' Form1
        ' 
        AutoScaleDimensions = New SizeF(9F, 19F)
        AutoScaleMode = AutoScaleMode.Font
        ClientSize = New Size(1316, 635)
        Controls.Add(Reset_MainWebview_Button)
